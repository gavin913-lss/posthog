...
import { featureFlagCalledPropertyCountHistogram } from '../../worker/ingestion/event-pipeline/metrics'
...
describe('createPrepareEventStep', () => {
    ...
    it('should strip non-whitelisted properties on $feature_flag_called events', async () => {
        const event = createTestPluginEvent({
